...
_G.packer_plugins = {
  ...
  ["lspsaga.nvim"] = {
    loaded = true,
    path = "/home/matt/.local/share/nvim/site/pack/packer/start/lspsaga.nvim",
  ...
  ["telescope-file-browser.nvim"] = {
    loaded = true,
    path = "/home/matt/.local/share/nvim/site/pack/packer/start/telescope-file-browser.nvim",
  ...
  ["vim-vsnip-integ"] = {
    loaded = true,
    path = "/home/matt/.local/share/nvim/site/pack/packer/start/vim-vsnip-integ",
